# Purpose: to train the LDA model on the sepal length and width
...
# Save the model
lda.save("lda_weights3.npz")

# Plotting the decision boundary for training data
plot_decision_regions(X_train, y_train.ravel(), clf=lda)
plt.title("LDA Decision Boundary")
plt.xlabel("Sepal Length")
plt.ylabel("Sepal Width")
plt.savefig("train_lda3.png")
plt.show()